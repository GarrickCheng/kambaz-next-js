...
export default function Lab1() {
    return (
      <div id="wd-lab1">
        <h2>Lab 1</h2>
        <h3>Garrick Cheng - Section 1</h3>
        
        <h4>Links</h4>
        <a id="wd-github" href="https://github.com/GarrickCheng/kambaz-next-js">GitHub Repository</a><br/>
        ...
        My favorite recipe(spaghetti carbonara):
        <ol id="wd-favorite-recipe">
          <li>Boil salted water and cook spaghetti for 11 minutes.</li>
          <li>Crisp pancetta or guanciale in a large pan.</li>
          <li>Whisk eggs with grated Parmesan and black pepper.</li>
          <li>Drain pasta, reserving pasta water.</li>
          <li>Add hot pasta to the pan with pancetta.</li>
          <li>Remove from heat and quickly toss with egg mixture.</li>
          <li>Add pasta water if needed.</li>
      ...
      <div id="wd-forms">
          ...
          <input type="text" id="wd-text-fields-first-name" title="Please type the first name of the user" /> <br />
        ...
        <h5>Buttons</h5>
        <button id="wd-hello-world" onClick={() => alert("Hello Life is Good!")}>
          Hello World!
        </button>
        ...
        <label htmlFor="wd-radio-red">Red</label><br />
        <input type="radio" name="radio-colors" id="wd-radio-green"/>
        <label htmlFor="wd-radio-green">Green</label><br />
        <input type="radio" name="radio-colors" id="wd-radio-blue"/>
        <label htmlFor="wd-radio-blue">Blue</label><br />
