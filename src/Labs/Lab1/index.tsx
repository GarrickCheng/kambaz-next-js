...
<div id="wd-tables">
  ...
  <form id="wd-text-fields">
    ...
    <input id="wd-text-fields-username" placeholder="Garrick" /> <br />
    ...
    <input type="text" id="wd-text-fields-last-name" placeholder="Cheng"
...
to get dummy text<br/>my text
        ...
        <a id="wd-github" href="https://github.com/GarrickCheng/kambaz-next-js" target="_blank" rel="noopener noreferrer"> GitHub</a>
        <br />
      </div>
